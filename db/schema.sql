...
--
-- Name: chats chats_chat_room_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.chats
    ADD CONSTRAINT chats_chat_room_id_foreign FOREIGN KEY (chat_room_id) REFERENCES public.chat_rooms(id) ON UPDATE CASCADE;


--
-- Name: chats chats_user_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.chats
    ADD CONSTRAINT chats_user_id_foreign FOREIGN KEY (user_id) REFERENCES public.users(id) ON UPDATE CASCADE;
